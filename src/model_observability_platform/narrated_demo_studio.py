...
def build_narrated_demo_studio(
    ...
    *,
    ...
    chapters = [
        {"chapter": "Establish The Operating Boundary", "duration_seconds": 28, "visual": primary_dashboard, "voice_note": "Calm, confident, operations-review introduction.", "script": f"This review follows {project_name} across its production control path: {domain}."},
