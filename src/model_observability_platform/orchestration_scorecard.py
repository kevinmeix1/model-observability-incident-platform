...
def build_orchestration_scorecard(
    ...
    *,
    ...
    checks = [
        ...
        ("alert_routing_guarded_remediation", _present(content, "alert_routing_remediation_plan.json", "AlertmanagerConfig", "inhibitRules") and _present(content, "columnLineage", "freeze-rollout-and-open-incident"), "Alertmanager grouping and inhibition route incidents while Argo Rollouts notifications and guarded remediation prevent unsafe automation"),
    ...
    report = {
        ...
        "research_basis": [
            ...
            "Prometheus Alertmanager grouping, routing, silencing, and inhibition with guarded remediation admission",
            "Argo Rollouts notifications and analysis hooks for rollout freeze and incident evidence events",
            "OpenLineage columnLineage dataset facet for column-level incident impact analysis",
